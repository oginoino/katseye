...
func (h *AddressHandler) GetAddress(c *gin.Context) {
	...
	response.NewSuccessResponse(c, "Address retrieved successfully", address)
}
...
func (h *AddressHandler) CreateAddress(c *gin.Context) {
	...
	err := h.addressService.CreateAddress(c.Request.Context(), &address)
	if err != nil {
		response.NewInternalServerErrorResponse(c, "Failed to create address", err.Error())
		return
	}

	response.NewCreatedResponse(c, "Address created successfully", address)
}
...
func (h *AddressHandler) UpdateAddress(c *gin.Context) {
	...
	err = h.addressService.UpdateAddress(c.Request.Context(), &address)
	if err != nil {
		response.NewInternalServerErrorResponse(c, "Failed to update address", err.Error())
		return
	}

	response.NewSuccessResponse(c, "Address updated successfully", address)
}
...
func (h *AddressHandler) DeleteAddress(c *gin.Context) {
	...
	err = h.addressService.DeleteAddress(c.Request.Context(), id)
	if err != nil {
...
func (h *AddressHandler) ListAddresses(c *gin.Context) {
	...
	if err != nil {
		response.NewInternalServerErrorResponse(c, "Failed to list addresses", err.Error())
		return
	}

	response.NewSuccessResponse(c, "Addresses retrieved successfully", addresses)
}